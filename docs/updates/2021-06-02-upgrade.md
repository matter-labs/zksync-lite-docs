...
## Added
- `MintNFT`, `WithdrawNFT` operations, which enable native NFT support. [doc] nft (../dev/nfts.md)
- `Swap` operation, which depending on the implementation may serve either order book or atomic swaps functionality. [doc] swaps (../dev/swaps.md)

...
That's why if your solution supports multiple chains (for example mainnet & goerli), please make sure that the user is signing ChangePubKey only after the transition to the correct network. 

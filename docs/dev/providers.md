...
JSON-RPC protocol allows for communication with the zkSync network nodes.
`Provider` is used to extract details of the communication and provides a useful API for interacting with the zkSync network.

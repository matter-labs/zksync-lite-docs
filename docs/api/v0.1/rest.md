...
Second enspoint should be used, for example, if you want to display sent transaction details (like in explorer
interface).
...
$ curl https://rinkeby-api.zksync.io/api/v0.1/transactions/0xe8b239b55804e58c2a55e2b567a9572811c19230d6a0d1f4a7840e7a0952b33d
{
  ...
  "prover_run": {
    "id": 2834,
    "block_number": 2817,
    "worker": "prover-76ccd5db5d-lggbh",
...
$ curl https://rinkeby-api.zksync.io/api/v0.1/priority_operations/1/
{
  ...
  "prover_run": {
    "id": 4,
    "block_number": 4,
    "worker": "prover-7bffc88f66-hmjvn",
